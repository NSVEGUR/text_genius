...
<main>
	...
	>
		...
		>
			...
			<a
				href="/about"
				class="flex items-center p-2 text-skin-inverted bg-accent border-[1px] border-accent transition-all duration-200 rounded-2xl px-3 hover:bg-transparent hover:text-skin-inverted"
				>Contact Us</a
			>
		</div>
